...
whoAgainstWhom.innerHTML = "Payer VS. Super-Computer";
...
function stupidComputerTurn() {
    ...
    if (vsComputerBolean && !win && !fullBoard) {
...
function winRow(activePlayerColor, activePlayer) {
    for (r = 0; r < ROW; r++){
        ...
        if (win == true){
            ...
            setTimeout(function() {
                announceWinner(activePlayerColor, activePlayer);
            }, 300);
